...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fullName = user?.userMetadata?['full_name'] ?? 'Traveler';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: Column(
                      children: [
                        ...
                        Text('12 Trips Planned • 24 Countries Visited',
                            style: GoogleFonts.plusJakartaSans(
                                fontSize: 16,
                  ...
                  _InfoCard(children: [
                    _FormField(label: 'Full Name', value: fullName),
                    ...
                    const SizedBox(height: 16),
                    const _FormField(
                        label: 'Home City', value: 'India, KL'),
                  ]),
                  ...
                  const Row(
                    children: [
                      Expanded(
                        ...
                        title: 'Travel Style',
                        subtitle:
                            'Prefers Group & Solo hybrid trips with local guides.',
                      )),
                      SizedBox(width: 12),
                      Expanded(
                          child: _PrefCard(
                    ...
                    child: ListView(
                      ...
                      children: const [
                        _DestChip(
                            city: 'Sydney, AU',
                            image:
                                'https://lh3.googleusercontent.com/aida-public/AB6AXuC07cCRbOYUEjmNtT8egA9_SOJg65PquP5C4wjWuZvNXEySw0I4xPfAd0ykjllRxvDEBdcq8TJzQIlgEtraUgH2irjXpEPhGGhSwgSwDSY5u1n30Pif0uWYuTGbmomP6oVfKOfvE7bRV1TnJW7aSGdoN5XQQ6hYnQS3mE59pPqjwGYtD2oYrTA6IeSdkNwmXmoxWNCpI9gAKAfxse_Z13oRRCWlYIrO-TEOum_2v9AASlBn9n4WveX-bdk3bWEMoNsBbT_b4Ykje_dT'),
                        _DestChip(
                            city: 'Venice, IT',
                            image:
                                'https://lh3.googleusercontent.com/aida-public/AB6AXuBZC4DkmuawC0N-RCpfFDgr5WAOFs6od77apZRDt1cy-ZWXBMQq3y2qUwAdN1jf1XCTFLqk3rbld8dZ4eRBWC3hYAsnVDROvlTsw9QXQSGKfIvI9yj5dPXHjSr2o9SJs4BFs6_FYfPs1pV3m-ibcfbYq-UrHaZjBdoXcnllSv-p3FRFFs-1_D8i9s-bVrfuTWpP0A4yM5xh-IfTAbZzb8CnU8Mm4tcjbGr9HRbmo6I_Y9-BL7dUQsC0O0zHv_P4rcfRY6AMojEGl8xs'),
                        _DestChip(
                            city: 'Kyoto, JP',
                            image:
                    ...
                    child: OutlinedButton.icon(
                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        side: const BorderSide(
                            color: TraveloopColors.error, width: 2),
                  ...
                  Center(
                    child: Text(
                        'Traveloop v2.4.1 • Proudly exploring since 2024',
                        style: GoogleFonts.plusJakartaSans(
                            fontSize: 10,
                            color: TraveloopColors.outline,
                            letterSpacing: 0.5)),
                  ),
                ],
              ),
...
class _FormField extends StatelessWidget {
  ...
  const _FormField(
      {required this.label, required this.value, this.keyboardType});
  @override
          ...
          children: [
            ...
            if (isToggle)
              Switch(
                  value: toggleValue,
                  onChanged: (_) {},
                  activeThumbColor: TraveloopColors.secondary)
